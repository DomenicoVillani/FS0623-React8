            ...
            {results && (
                <div>
                    <Row className="justify-content-center text-white">
                        <Col xs={3} className="my-card m-3 d-flex justify-content-around align-items-center my-animation">
                            <h2 className="text-white">Percepiti</h2>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-thermometer-half text-white" viewBox="0 0 16 16">
                        ...
                        <Col xs={3} className="my-card m-3 d-flex justify-content-around align-items-center my-animation">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-wind text-white" viewBox="0 0 16 16">
                        ...
                        <Col xs={3} className="my-card m-3 d-flex justify-content-around align-items-center my-animation">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-moisture text-white" viewBox="0 0 16 16">
